...
// class block 외부에 작성 할 수 있는 code는 다른 class정의
/*
 * package 명시
 * import 명시 
 * 만 가능하다.
 ...
 *  @author choi
 *  @since 2024-04-25
 *  @apiNote 현재 문서에서는 연산자 중에 <b>산술연산자</b>를 학습합니다
 */
public class Operators00ArithmeticTest {
	// 메인 method가 포함되어 있는 문서에  focus가 가 있을 경우에는
	// ctrl + f11 로 실행가능
	public static void main(String[] args) {
		System.out.println("--- Main 프로그램 실행");
		
		int num1 = +10;
		int num2 = 20; // + 부호는 생략해도 양의정수를 표현
		...
		/*
	 	  -  *  /  %
	 	 TODO num1 과 num2의 나머지 산술연산결과를 result 변수에 저장하여 출력
